...
function Toggle() {
    ...
    const [toggled, setToggled] = useState(resolvedTheme === "dark");
    ...
    // Sync toggle state with theme state
    useEffect(() => {
        setToggled(resolvedTheme === "dark");
    }, [resolvedTheme]);
    ...
    const handleToggle = () => {
        // Mulai animasi dan ubah state internal untuk kontrol visual
        setToggled(!toggled);

        // Ubah tema setelah delay animasi selesai
        setTimeout(() => {
